...
이 문서는 기존 `kyuboard-detailed-design.md`의 시스템 설계와 `drawing-basic-design.md`의 드로잉 설계를 합친 KyuBoard 기준 문서다. 컴포넌트 내부 구현은 [상세설계 인덱스](./kyuboard-detailed-design.md)에서 관리한다.
